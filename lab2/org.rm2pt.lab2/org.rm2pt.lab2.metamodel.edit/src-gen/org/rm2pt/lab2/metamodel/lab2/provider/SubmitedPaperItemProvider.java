...
/**
 * This is the item provider adapter for a {@link org.rm2pt.lab2.metamodel.lab2.SubmitedPaper} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubmitedPaperItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addCouseridPropertyDescriptor(object);
	...
	protected void addStudentidPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SubmitedPaper_studentid_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SubmitedPaper_studentid_feature",
								"_UI_SubmitedPaper_type"),
						Lab2Package.Literals.SUBMITED_PAPER__STUDENTID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addTeacheridPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SubmitedPaper_teacherid_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SubmitedPaper_teacherid_feature",
								"_UI_SubmitedPaper_type"),
						Lab2Package.Literals.SUBMITED_PAPER__TEACHERID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}

	/**
	 * This adds a property descriptor for the Couserid feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addCouseridPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SubmitedPaper_couserid_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SubmitedPaper_couserid_feature",
								"_UI_SubmitedPaper_type"),
						Lab2Package.Literals.SUBMITED_PAPER__COUSERID, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
	...
	protected void addWhichcoursePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SubmitedPaper_whichcourse_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SubmitedPaper_whichcourse_feature",
								"_UI_SubmitedPaper_type"),
						Lab2Package.Literals.SUBMITED_PAPER__WHICHCOURSE, true, false, true, null, null, null));
	}
	...
	protected void addWhichteacherPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SubmitedPaper_whichteacher_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SubmitedPaper_whichteacher_feature",
								"_UI_SubmitedPaper_type"),
						Lab2Package.Literals.SUBMITED_PAPER__WHICHTEACHER, true, false, true, null, null, null));
	}
	...
	protected void addWhichstudentPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_SubmitedPaper_whichstudent_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_SubmitedPaper_whichstudent_feature",
								"_UI_SubmitedPaper_type"),
						Lab2Package.Literals.SUBMITED_PAPER__WHICHSTUDENT, true, false, true, null, null, null));
	}
