...
public class Lab2Switch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case Lab2Package.TEACHER: {
			...
			if (result == null)
				result = caseUser(teacher);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case Lab2Package.EXAMINATION_PAPER: {
			ExaminationPaper examinationPaper = (ExaminationPaper) theEObject;
			T result = caseExaminationPaper(examinationPaper);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		...
		case Lab2Package.CLASS: {
			org.rm2pt.lab2.metamodel.lab2.Class class_ = (org.rm2pt.lab2.metamodel.lab2.Class) theEObject;
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Examination Paper</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Examination Paper</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseExaminationPaper(ExaminationPaper object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseClass(org.rm2pt.lab2.metamodel.lab2.Class object) {
		return null;
	}
