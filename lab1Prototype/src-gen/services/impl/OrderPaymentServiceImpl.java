...
public class OrderPaymentServiceImpl implements OrderPaymentService, Serializable {
	...
	public boolean orderPay(String orderId, String goodsId, String goodsName, String goodsNum, String totalPrice) throws PreconditionException, PostconditionException, ThirdPartyServiceException {
	...
	static {opINVRelatedEntity.put("orderPay", Arrays.asList("Orders"));}
